...
This directory contains platform-specific build scripts for simple-metricd that automate the build and installation process.
...
Deploy and manage Docker containers for simple-metricd.
...
export CMAKE_INSTALL_PREFIX=/opt/simple-metricd
./scripts/build-linux.sh
...
# This creates:
# - simple-metricd-0.1.0-static-linux.tar.gz
# - simple-metricd-0.1.0-static-macos.tar.gz
# - simple-metricd-0.1.0-static-windows.zip
```
