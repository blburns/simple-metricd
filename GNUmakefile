# Makefile for simple-metricd
# Simple Metrics Daemon - A lightweight metrics daemon
...
docker-run:
	docker run -d --name $(PROJECT_NAME)-$(VERSION) -p 389:389 -p 636:636 $(PROJECT_NAME):$(VERSION)
...
help:
	@echo "Simple Metrics Daemon - A lightweight metrics daemon - Main Help"
	@echo "=================================="
	@echo ""
...
help-all:
	@echo "Simple Metrics Daemon - A lightweight metrics daemon - All Available Targets"
	@echo "=============================================="
	@echo ""
	@echo "Essential targets:"
	@echo "  all              - Build the project (default)"
